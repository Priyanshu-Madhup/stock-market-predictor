...
image_icon = PhotoImage(file="s_logo2.png")
root.iconphoto(False, image_icon)

img = PhotoImage(file="STOCK MARKET PREDICTOR AND SUGGESTOR (2).png")
img_loc = Label(root, image=img, bg='white').place(x=50, y=50)

simg = PhotoImage(file="Untitled design (7).png")
...
s_icon = PhotoImage(file="s_icon2.png")
